...
import { userSignupAPI } from "../../redux/actions/userAction/useraction";
        ...
        <div className="w-full py-6 z-20">
          ...
          >
            ...
            <div className="pb-2 pt-4">
              ...
              />
              {formik.touched && formik.errors ? (
                <p className="text-white text-left">{formik.errors.matKhau}</p>
              ) : null}
            </div>
            <div className="pb-2 pt-4">
              <input
              ...
              />
              {formik.touched && formik.errors ? (
                <p className="text-white text-left">{formik.errors.hoTen}</p>
              ) : null}
            </div>
            <div className="pb-2 pt-4">
              <input
              ...
              />
              {formik.touched && formik.errors ? (
                <p className="text-white text-left">{formik.errors.email}</p>
              ) : null}
            </div>
            <div className="pb-2 pt-4">
              <input
              ...
              />
              {formik.touched && formik.errors ? (
                <p className="text-white text-left">{formik.errors.soDt}</p>
              ) : null}
            </div>
            ...
            <div className=" pb-2 pt-4 flex">
              ...
              <NavLink
                to="/login"
                className="uppercase group block w-full p-4 text-lg text-white hover:text-white bg-indigo-400 hover:bg-indigo-600 focus:outline-none"
              >
